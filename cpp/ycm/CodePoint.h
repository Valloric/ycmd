...
//  - its uppercase version: identical to the code point if no uppercase
//    version;
//  - its swapped case version: lowercase if the code point is uppercase,
//    uppercase if the code point is lowercase, identical if no lowercase and
//    uppercase versions;
