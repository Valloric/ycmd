...
using FilepathToIdentifiers = google::dense_hash_map< std::string,
                                        std::vector< std::string > >;

// filetype -> (filepath -> identifiers)
using FiletypeIdentifierMap = google::dense_hash_map< std::string, FilepathToIdentifiers >;
...
private:
  google::dense_hash_set< const Candidate * > &GetCandidateSet(
    const std::string &filetype,
    const std::string &filepath );
  ...
  using FilepathToCandidates =
    google::dense_hash_map < std::string,
                         std::shared_ptr< google::dense_hash_set< const Candidate * > > >;

  // filetype -> *( filepath -> *( *candidate ) )
  using FiletypeCandidateMap =
    google::dense_hash_map < std::string, std::shared_ptr< FilepathToCandidates > >;
