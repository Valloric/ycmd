...
def Lowercase( code_points, unicode_data ):
  lower_code_points = []
  for code_point in code_points:
    lowercase = unicode_data[ code_point ][ 'lowercase' ]
    lower_code_point = lowercase if lowercase else code_point
    lower_code_points.append( lower_code_point )
  return lower_code_points


def Uppercase( code_points, unicode_data ):
  upper_code_points = []
  for code_point in code_points:
    uppercase = unicode_data[ code_point ][ 'uppercase' ]
    upper_code_point = uppercase if uppercase else code_point
    upper_code_points.append( upper_code_point )
...
def GetCodePoints():
  ...
  for key, value in unicode_data.items():
    ...
    lower_code_points = Lowercase( normal_code_points, unicode_data )
    upper_code_points = Uppercase( normal_code_points, unicode_data )
    ...
    if ( code_point != normal_code_point or
         code_point != upper_code_point or
