...
def Main():
  ...
  # parser.add_argument( '--s3-bucket', action='store', required=True,
  #                      help='Name of the s3 bucket to store in' )
  ...
  for os_name, download_data in iteritems( LLVM_DOWNLOAD_DATA ):
    ...
    with TemporaryDirectory() as temp_dir:
      ...
      UploadBundleToBintray( args.bt_user,
                             ...
                             args.version,
                             ycmd_package_file )
      # UploadBundleToS3( args.s3_bucket, args.version, ycmd_package_file )
