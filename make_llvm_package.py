...
def ParseArguments():
  ...
  parser.add_argument( 'version', action='store', help = 'The LLVM Version' )
  parser.add_argument( '--from-cache', action='store', required=False,
                       help = 'Use the clang bins from this dir' )
  parser.add_argument( '--output-dir', action='store', required=False,
                       help = 'Where to put them' )
  parser.add_argument( '--bt-user', action='store', required=False,
                       help = 'Bintray user' )
  parser.add_argument( '--bt-token', action='store', required=False,
