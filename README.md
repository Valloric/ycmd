...
- a dictionary containing the following items:
  ...
  - `do_cache`: (mandatory) a boolean indicating whether or not the result of
    this call (i.e. the list of flags) should be cached for this file name. If
    you're not sure what this means, just set it to `True`.

  - `flags_ready`: (optional) a boolean indicating that the flags should be
    used. Defaults to `True`. Not usually supplied.
