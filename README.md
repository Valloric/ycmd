...
This variable is a more convenient but less flexible way to configure the Python
completer compared to the `PythonSettings` function. It is defined as the return
value of that function. If both are set, `PythonSettings` takes priority.
