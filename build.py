...
def GetRustup( install_dir ):
  ...
  if ( PY_MAJOR, PY_MINOR, PY_PATCH ) < ( 2, 7, 9 ):
    return FindExecutableOrDie( 'rustup',
  ...
  if OnWindows():
    ...
    rustup_url = 'https://win.rustup.rs/{}'.format( 'x86_64' if IS_64BIT else
                                                    'i686' )
  else:
  ...
  return os.path.join( install_dir, 'bin', 'rustup' )
