...
curl https://download.mono-project.com/archive/5.12.0/macos-10-universal/MonoFramework-MDK-5.12.0.226.macos10.xamarin.universal.pkg -o ${TMPDIR}/mono.pkg
sudo installer -pkg ${TMPDIR}/mono.pkg -target /
