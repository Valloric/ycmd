...
mkdir -p ${HOME}/mono
curl https://download.mono-project.com/archive/5.12.0/macos-10-universal/MonoFramework-MDK-5.12.0.226.macos10.xamarin.universal.pkg -o ${HOME}/mono/mono-5.12.0.pkg
sudo installer -pkg ${HOME}/mono/mono-5.12.0.pkg -target /
