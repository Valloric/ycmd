...
class PreparedTriggers( object ):
  ...
  def MatchesForFiletype( self, current_line, start_column, filetype ):
    return self.MatchingTriggerForFiletype( current_line, start_column, filetype ) is not None
...
def _MatchesSemanticTrigger( line_value, start_column, trigger_list ):
  return _MatchingSemanticTrigger( line_value, start_column, trigger_list ) is not None
