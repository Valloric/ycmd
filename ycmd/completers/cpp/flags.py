...
def _AddSystemHeaderPaths( flags, filename ):
  ...
  # If the file has no extension and no language flag -x is given, it's most
  # likely a header from the STL. Force the language to C++.
