...
def _RemoveUnusedFlags( flags, filename, enable_windows_style_flags ):
  ...
  # Windows style flags
  previous_flag_starts_with_slash = False
  ...
  for flag in flags:
    ...
    previous_flag_starts_with_slash = current_flag_starts_with_slash
    ...
    if _SkipStrayFilenameFlag( flag,
                               current_flag_starts_with_dash,
                               previous_flag_starts_with_dash,
                               current_flag_starts_with_slash,
                               previous_flag_starts_with_slash,
                               previous_flag_is_include,
...
def UserIncludePaths( flags, filename ):
  ...
  if flags:
    ...
    # TODO: Should we care about `/I` when enable_windows_style_flags
    # is not set
    path_flags = [ '-isystem', '-I' ] + INCLUDE_FLAGS_WIN_STYLE
