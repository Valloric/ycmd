...
def _EnableTypoCorrection( flags ):
  ...
  # 'string'? (FixIt)". This is enabled by default in the clang driver and is
  # a feature useful enough that we just always turn it on. That is, unless
  # the user explicitly turned it off (with -fno-spell-checking).
