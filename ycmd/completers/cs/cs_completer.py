...
class CsharpCompleter( Completer ):
  ...
  def ServerIsHealthy( self ):
    ...
    return self._CheckAll( lambda i: i.ServerIsHealthy() )


  def ServerIsReady( self ):
    """ Check if our OmniSharp server is ready (loaded solution file)."""
    return self._CheckAll( lambda i: i.ServerIsReady() )


  def _CheckAll( self, action ):
    solutioncompleters = self._completer_per_solution.values()
    self._logger.info( solutioncompleters )
