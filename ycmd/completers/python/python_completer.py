  ...
  def _GetSettings( self, module, client_data ):
    ...
    if module:
      if hasattr( module, 'Settings' ):
        return module.Settings( filetype = 'python', client_data = client_data )
      if hasattr( module, 'settings' ):
        settings = module.settings
        return settings.get( 'python', {} )
      self._logger.debug( 'No settings variable or Settings function defined '
                          'in %s', module.__file__ )
    return {
