...
class PythonCompleter( Completer ):
  ...
  def _GoToSymbol( self, request_data, args ):
    ...
    # TODO: Should we just request _all_ symbols and use our own FilterAndSort?
    # that way it's the same search as our completion engine. Though, jedi docs
    # say you shouldn't even exhaust the generator due to performance issues
    query = args[ 0 ]
