...
# Exit statuses returned by the CompatibleWithCurrentCore function. Values 1 and
# 2 are not used because 1 is for general errors and 2 has often a special
# meaning for Unix programs. See
