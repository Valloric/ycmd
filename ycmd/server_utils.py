...
# Status codes returned by the CompatibleWithCurrentCore function. The value 2
# is not used because it has often a special meaning for Unix programs. See
# https://docs.python.org/2/library/sys.html#sys.exit
CORE_COMPATIBLE_STATUS  = 0
UNEXPECTED_ERROR_STATUS = 1
CORE_MISSING_STATUS     = 3
CORE_PYTHON2_STATUS     = 4
CORE_PYTHON3_STATUS     = 5
CORE_OUTDATED_STATUS    = 6
...
def CompatibleWithCurrentCore():
  ...
  try:
    ...
    return UNEXPECTED_ERROR_STATUS
