...
class RequestWrap( object ):
  def __init__( self, request, validate = True ):
    ...
    # tuple of ( getter_method, setter_method ). Values computed by
    # getter_method (or set by setter_method) are cached in _cached_computed.
    # setter_method may be None for read-only items.
    self._computed_key = {
