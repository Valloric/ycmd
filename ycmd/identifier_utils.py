...
FILETYPE_TO_COMMENT_AND_STRING_REGEX = {
  ...
  'cpp': re.compile( SINGLE_QUOTE_STRING + "|" +
                     DOUBLE_QUOTE_STRING + "|" +
                     C_STYLE_COMMENT + "|" +
                     CPP_STYLE_COMMENT, re.MULTILINE ),

  # Spec:
  # https://golang.org/ref/spec#String_literals
  # https://golang.org/ref/spec#Rune_literals
  # https://golang.org/ref/spec#Comments
  'go': re.compile( SINGLE_QUOTE_STRING + "|" +
                    DOUBLE_QUOTE_STRING + "|" +
                    BACK_QUOTE_STRING + "|" +
                    C_STYLE_COMMENT + "|" +
                    CPP_STYLE_COMMENT, re.MULTILINE ),
  ...
  'python': re.compile( MULTILINE_SINGLE_QUOTE_STRING + "|" +
                        MULTILINE_DOUBLE_QUOTE_STRING + "|" +
                        SINGLE_QUOTE_STRING + "|" +
                        DOUBLE_QUOTE_STRING + "|" +
                        PYTHON_STYLE_COMMENT, re.MULTILINE ),

  # Spec:
  # https://doc.rust-lang.org/reference.html#character-and-string-literals
  # https://doc.rust-lang.org/reference.html#comments
  'rust': re.compile( SINGLE_QUOTE_STRING + "|" +
                      DOUBLE_QUOTE_STRING + "|" +
                      CPP_STYLE_COMMENT, re.MULTILINE )
}
