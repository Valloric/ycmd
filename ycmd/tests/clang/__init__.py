...
def TemporaryProjectDir():
  ...
  See also |TemporaryProjectDir|. The context manager yields the path of the
  temporary directory."""
...
def TemporaryProject( tmp_dir, compile_commands ):
  ...
  database file (typically used in conjunction with |TemporaryProjectDir|) and
  ...
  e.g.:
    with TemporaryProjectDir() as tmp_dir:
      ...
      with TemporaryProject( tmp_dir, database ):
        <test here>
