...
@SharedYcmd
def DebugInfo_FlagsWhenNoExtraConfFoundAndNoCompilationDatabase_test( app ):
...
@IsolatedYcmd
def DebugInfo_FlagsWhenExtraConfFoundButNotLoadedAndNoCompilationDatabase_test(
  app ):
