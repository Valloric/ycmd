...
@SharedYcmd
def GetCompletions_QuotedInclude_WithIncludeFlags_test( app ):
  RunTest( app, {
    'description': 'completion of #include " with additional include paths',
    'request': {
      'filetype'  : 'cpp',
      'filepath'  : PathToTestFile( 'test-include', 'main.cpp' ),
      'line_num'  : 9,
...
@SharedYcmd
def GetCompletions_QuotedInclude_AfterDirectory_test( app ):
  RunTest( app, {
...
@SharedYcmd
def GetCompletions_BracketInclude_WithIncludeFlags_test( app ):
  RunTest( app, {
    'description': 'completion of #include < with additional include paths',
    'request': {
      'filetype'  : 'cpp',
...
@SharedYcmd
def GetCompletions_BracketInclude_Directory_test( app ):
  RunTest( app, {
