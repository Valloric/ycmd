...
def Subcommands_GoTo_all_Fail_test():
  # GoToDeclaration on keyword.
  test = { 'request': [ 16, 6 ], 'response': [ 1, 1 ] }
  assert_that(
  ...
  # GoToDefinition on Another_Unicøde.
  test = { 'request': [ 36, 17 ], 'response': [ 1, 1 ] }
  assert_that(
    calling( RunGoToTest_all ).with_args( 'GoTo_all_Clang_test.cc',
                                          [ 'GoToDefinition' ],
                                          test ),
  ...
  # GoTo on closing brace.
  test = { 'request': [ 17, 1 ], 'response': [ 1, 1 ] }
  assert_that(
    calling( RunGoToTest_all ).with_args( 'GoTo_all_Clang_test.cc',
                                          [ 'GoTo' ],
                                          test ),
  ...
  # GoToImprecise on nothing.
  test = { 'request': [ 13, 1 ], 'response': [ 1, 1 ] }
  assert_that(
    calling( RunGoToTest_all ).with_args( 'GoTo_all_Clang_test.cc',
                                          [ 'GoToImprecise' ],
                                          test ),
