...
from hamcrest import assert_that, has_entries, matches_regexp
...
@SharedYcmd
def Subcommands_DebugInfo_ServerIsRunning_test( app ):
  subcommands_data = BuildRequest( completer_target = 'go' )
  assert_that(
...
@IsolatedYcmd
def Subcommands_DebugInfo_ServerIsNotRunning_LogfilesExist_test( app ):
...
@IsolatedYcmd
def Subcommands_DebugInfo_ServersIsNotRunning_LogfilesDoNotExist_test( app ):
