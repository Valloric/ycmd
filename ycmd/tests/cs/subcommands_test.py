...
class Cs_Subcommands_test( Cs_Handlers_test ):
  ...
  def _RunFixIt( self, line, column, expected_result, use_roslyn ):
    if use_roslyn:
      raise SkipTest( "Rosyln doesn't seem to support fixit yet" )
  ...
  def StopServer_KeepLogFiles_test( self ):
    yield self._StopServer_KeepLogFiles, True, True
    yield self._StopServer_KeepLogFiles, False, True
    yield self._StopServer_KeepLogFiles, True, False
    yield self._StopServer_KeepLogFiles, False, False


  def _StopServer_KeepLogFiles( self, keeping_log_files, use_roslyn ):
    if use_roslyn:
