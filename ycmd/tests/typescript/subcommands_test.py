  ...
  assert_that( response, has_entries ( {
    'fixits': contains( has_entries( {
      'chunks': contains_inanyorder(
        ChunkMatcher(
          'test',
          LocationMatcher( filepath, 9, 15 ),
          LocationMatcher( filepath, 9, 18 ) ),
        ChunkMatcher(
          'test',
  ...
  assert_that( response, has_entries ( {
    'fixits': contains( has_entries( {
      'chunks': contains_inanyorder(
        ChunkMatcher(
          'this-is-a-longer-string',
          LocationMatcher( filepath, 20, 7 ),
          LocationMatcher( filepath, 20, 10 ) ),
        ChunkMatcher(
          'this-is-a-longer-string',
          LocationMatcher( filepath, 28, 15 ),
          LocationMatcher( filepath, 28, 18 ) ),
        ChunkMatcher(
          'this-is-a-longer-string',
          LocationMatcher( filepath, 32, 1 ),
      ...
      'location': LocationMatcher( filepath, 20, 9 )
    } ) )
  } ) )
