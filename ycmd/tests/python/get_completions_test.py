...
@IsolatedYcmd( { 'global_ycm_extra_conf':
                 PathToTestFile( 'project',
                                 'settings_function_extra_conf.py' ) } )
...
def GetCompletions_SysPath_SettingsNoneInExtraConf_test( app ):
  RunTest( app, {
    'description': 'Settings return None in extra conf file',
    'request': {
      'filetype'  : 'python',
      'filepath'  : PathToTestFile( 'project', '__main__.py' ),
      'line_num'  : 3,
...
@IsolatedYcmd( { 'global_ycm_extra_conf':
                 PathToTestFile( 'project', 'settings_dict_extra_conf.py' ) } )
def GetCompletions_SysPath_SettingsDictionaryInExtraConf_test( app ):
  RunTest( app, {
    'description': 'Module is added to sys.path through the settings '
                   'dictionary in extra conf file',
    'request': {
      'filetype'  : 'python',
      'filepath'  : PathToTestFile( 'project', '__main__.py' ),
      'line_num'  : 3,
...
def GetCompletions_SysPath_SettingsEmptyInExtraConf_test( app ):
  RunTest( app, {
    'description': 'The settings dictionary is empty in extra conf file',
    'request': {
      'filetype'  : 'python',
      'filepath'  : PathToTestFile( 'project', '__main__.py' ),
      'line_num'  : 3,
