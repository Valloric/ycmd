...
@IsolatedYcmd( { 'global_ycm_extra_conf':
                 PathToTestFile( 'project',
                                 'python_settings_extra_conf.py' ) } )
def GetCompletions_SysPath_PythonSettingsInExtraConf_test( app ):
  RunTest( app, {
    'description': 'Module is added to sys.path through the PythonSettings '
...
def GetCompletions_SysPath_SettingsInExtraConf_test( app ):
  RunTest( app, {
