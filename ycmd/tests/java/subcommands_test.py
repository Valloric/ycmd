...
@SharedYcmd
def Subcommands_Format_WholeFile_DefaultOptions_test( app ):
  filepath = PathToTestFile( 'simple_eclipse_project',
                             'src',
                             'com',
                             'youcompleteme',
...
@SharedYcmd
def Subcommands_Format_WholeFile_CustomTabSize_test( app ):
  filepath = PathToTestFile( 'simple_eclipse_project',
                             'src',
                             'com',
                             'youcompleteme',
...
@SharedYcmd
def Subcommands_Format_Range_DefaultOptions_test( app ):
  filepath = PathToTestFile( 'simple_eclipse_project',
                             'src',
                             'com',
                             'youcompleteme',
...
@SharedYcmd
def Subcommands_Format_Range_CustomTabSize_test( app ):
  filepath = PathToTestFile( 'simple_eclipse_project',
                             'src',
                             'com',
                             'youcompleteme',
